...
1. Add the final module: **Gmail -> Send an email.**
2. Connect your Gmail account.
3. Configure the email parameters:
   - **To**: Map the recipient email address (or use a test email).
   - **Subject**: `Your Invoice for {{service_name}}`
   - **Content**: Add a brief message thanking the customer.
   - **Attachments**: Select the output file generated by the Google Docs module.
4. Execute the Gmail module to send the final email.
